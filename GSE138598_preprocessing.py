...
if __name__ == "__main__":
    srrs = ['SRR10247148', 'SRR10247150', 'SRR10247157', 'SRR10247162', 'SRR10247172', 'SRR10247173', 'SRR10247182',
    ...
    for i in range(len(srrs)):
        ...
        if call(f'trim_galore --gzip --cores {cores_num} --clip_R1 3 --clip_R2 3 --illumina --paired {srr}_1.fastq.gz {srr}_2.fastq.gz', shell=True)!=0:
